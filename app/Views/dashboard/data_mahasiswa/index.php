                            ...
                            <div id="editModal-<?= $value['id'] ?>" class="modal fade" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= base_url('data-mahasiswa/update/' . $value['id']) ?>" method="post">
                                            <?= csrf_field() ?>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12 mb-2">
                                                        <label class="form-label" id="nama_lengkap">Nama Lengkap</label>
                                                        <input class="form-control" name="nama_lengkap" type="text" placeholder="Masukan nama lengkap" value="<?= $value['nama_lengkap'] ?>">
                                                    </div>
                                                    <div class="col-md-12">
                                                        <label class="form-label" id="nim">NIM</label>
                                                        <input class="form-control" name="username" type="text" placeholder="Masukan nim" value="<?= $value['username'] ?>">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div id="deleteModal-<?= $value['id'] ?>" class="modal fade" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="<?= base_url('data-mahasiswa/delete/' . $value['id']) ?>" method="post">
                                            <?= csrf_field() ?>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
            ...
            <form action="<?= base_url('data-mahasiswa') ?>" method="post">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <label class="form-label" id="nim">NIM</label>
                            <input class="form-control" name="username" type="text" placeholder="Masukan nim">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
