        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?= base_url('seminar-kemajuan') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="draft_proposal" class="col-md-2 col-form-label">Draft Proposal <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="lembar_seminar" class="col-md-2 col-form-label">Lembar Pendaftaran Seminar <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
