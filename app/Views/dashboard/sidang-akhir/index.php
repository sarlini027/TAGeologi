        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?= base_url('sidang-akhir') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="kendali_bimbingan" class="col-md-2 col-form-label">Form Bimbingan <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="form_pendaftaran_sidang" class="col-md-2 col-form-label">Form Pendaftaran <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="form_bimbingan" class="col-md-2 col-form-label">Form Bimbingan <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="kehadiran_seminar" class="col-md-2 col-form-label">Form Kehadiran <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="transkrip_nilai" class="col-md-2 col-form-label">Transkrip Nilai <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
