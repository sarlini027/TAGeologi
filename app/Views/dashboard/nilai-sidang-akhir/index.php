        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="datatable table table-bordered dt-responsive  nowrap w-100">
                    ...
                    <tbody>
                        <?php foreach ($listAccSidangAkhir as $key => $value): ?>
                            <tr>
                                <td><?= $key + 1 ?></td>
                                ...
                                <div id="editModal<?= $value['user_id'] ?>" class="modal fade" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= base_url('nilai-sidang-akhir/update') ?>" method="post">
                                                <?= csrf_field() ?>
...
<div id="addModal" class="modal fade" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('nilai-sidang-akhir') ?>" method="post">
                <?= csrf_field() ?>
