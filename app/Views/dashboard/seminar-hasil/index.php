        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?= base_url('seminar-hasil') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="bukti_kehadiran" class="col-md-2 col-form-label">Bukti Kehadiran <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
                    ...
                    <div class="mb-3 row align-items-center">
                        <label for="kendali_bimbingan_semhas" class="col-md-2 col-form-label">Kendali Bimbingan Seminar Hasil <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
                    ...
                    <!-- <div class="mb-3 row">
                        <label for="form_pendaftaran_dosbing" class="col-md-2 col-form-label">Form Pendaftaran Dosbing <span style="color: red">* <small>(PDF, maks: 10MB)</small></span></label>
                        <div class="col-md-10">
